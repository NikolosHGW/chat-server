...
//go:generate minimock -i github.com/NikolosHGW/chat-server/internal/api/chat.Service -o service_minimock.go -n ServiceMock -p mocks
...
func (mmCreate *mServiceMockCreate) Expect(ctx context.Context, ia1 []int64) *mServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &ServiceMockCreateParams{ctx, ia1}
...
// ExpectIa1Param2 sets up expected param ia1 for Service.Create
func (mmCreate *mServiceMockCreate) ExpectIa1Param2(ia1 []int64) *mServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mServiceMockCreate) Inspect(f func(ctx context.Context, ia1 []int64)) *mServiceMockCreate {
...
func (mmCreate *mServiceMockCreate) Set(f func(ctx context.Context, ia1 []int64) (i1 int64, err error)) *ServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mServiceMockCreate) When(ctx context.Context, ia1 []int64) *ServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &ServiceMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &ServiceMockCreateParams{ctx, ia1},
...
func (mmCreate *ServiceMock) Create(ctx context.Context, ia1 []int64) (i1 int64, err error) {
	...
	mm_params := ServiceMockCreateParams{ctx, ia1}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ServiceMockCreateParams{ctx, ia1}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ia1 != nil && !minimock.Equal(*mm_want_ptrs.ia1, mm_got.ia1) {
				mmCreate.t.Errorf("ServiceMock.Create got unexpected parameter ia1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to ServiceMock.Create. %v %v", ctx, ia1)
	return
}
...
func (mmDelete *mServiceMockDelete) Expect(ctx context.Context, i1 int64) *mServiceMockDelete {
	...
	mmDelete.defaultExpectation.params = &ServiceMockDeleteParams{ctx, i1}
...
// ExpectI1Param2 sets up expected param i1 for Service.Delete
func (mmDelete *mServiceMockDelete) ExpectI1Param2(i1 int64) *mServiceMockDelete {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("ServiceMock.Delete mock is already set by Set")
	}
...
func (mmDelete *mServiceMockDelete) Inspect(f func(ctx context.Context, i1 int64)) *mServiceMockDelete {
...
func (mmDelete *mServiceMockDelete) Set(f func(ctx context.Context, i1 int64) (err error)) *ServiceMock {
	if mmDelete.defaultExpectation != nil {
...
// Then helper
func (mmDelete *mServiceMockDelete) When(ctx context.Context, i1 int64) *ServiceMockDeleteExpectation {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("ServiceMock.Delete mock is already set by Set")
	}
	...
	expectation := &ServiceMockDeleteExpectation{
		mock:               mmDelete.mock,
		params:             &ServiceMockDeleteParams{ctx, i1},
...
func (mmDelete *ServiceMock) Delete(ctx context.Context, i1 int64) (err error) {
	...
	mm_params := ServiceMockDeleteParams{ctx, i1}
	...
	if mmDelete.DeleteMock.defaultExpectation != nil {
		...
		mm_got := ServiceMockDeleteParams{ctx, i1}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.i1 != nil && !minimock.Equal(*mm_want_ptrs.i1, mm_got.i1) {
				mmDelete.t.Errorf("ServiceMock.Delete got unexpected parameter i1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmDelete.t.Fatalf("Unexpected call to ServiceMock.Delete. %v %v", ctx, i1)
	return
}
