...
//go:generate minimock -i github.com/NikolosHGW/chat-server/internal/api/chat.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
// ChatServiceMock implements mm_chat.ChatService
type ChatServiceMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcCreate          func(ctx context.Context, ia1 []int64) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, ia1 []int64)
...
// NewChatServiceMock returns a mock for mm_chat.ChatService
...
func (mmCreate *mChatServiceMockCreate) Expect(ctx context.Context, ia1 []int64) *mChatServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &ChatServiceMockCreateParams{ctx, ia1}
...
// ExpectIa1Param2 sets up expected param ia1 for ChatService.Create
func (mmCreate *mChatServiceMockCreate) ExpectIa1Param2(ia1 []int64) *mChatServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.paramPtrs.ia1 = &ia1
	mmCreate.defaultExpectation.expectationOrigins.originIa1 = minimock.CallerInfo(1)

	return mmCreate
}

// Inspect accepts an inspector function that has same arguments as the ChatService.Create
func (mmCreate *mChatServiceMockCreate) Inspect(f func(ctx context.Context, ia1 []int64)) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) Set(f func(ctx context.Context, ia1 []int64) (i1 int64, err error)) *ChatServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatServiceMockCreate) When(ctx context.Context, ia1 []int64) *ChatServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &ChatServiceMockCreateParams{ctx, ia1},
...
// Create implements mm_chat.ChatService
func (mmCreate *ChatServiceMock) Create(ctx context.Context, ia1 []int64) (i1 int64, err error) {
	...
	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, ia1)
	}

	mm_params := ChatServiceMockCreateParams{ctx, ia1}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockCreateParams{ctx, ia1}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ia1 != nil && !minimock.Equal(*mm_want_ptrs.ia1, mm_got.ia1) {
				mmCreate.t.Errorf("ChatServiceMock.Create got unexpected parameter ia1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreate.CreateMock.defaultExpectation.expectationOrigins.originIa1, *mm_want_ptrs.ia1, mm_got.ia1, minimock.Diff(*mm_want_ptrs.ia1, mm_got.ia1))
			}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, ia1)
	}
	mmCreate.t.Fatalf("Unexpected call to ChatServiceMock.Create. %v %v", ctx, ia1)
	return
}
...
func (mmDelete *mChatServiceMockDelete) Expect(ctx context.Context, i1 int64) *mChatServiceMockDelete {
	...
	mmDelete.defaultExpectation.params = &ChatServiceMockDeleteParams{ctx, i1}
...
// ExpectI1Param2 sets up expected param i1 for ChatService.Delete
func (mmDelete *mChatServiceMockDelete) ExpectI1Param2(i1 int64) *mChatServiceMockDelete {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("ChatServiceMock.Delete mock is already set by Set")
	}
...
func (mmDelete *mChatServiceMockDelete) Inspect(f func(ctx context.Context, i1 int64)) *mChatServiceMockDelete {
...
func (mmDelete *mChatServiceMockDelete) Set(f func(ctx context.Context, i1 int64) (err error)) *ChatServiceMock {
	if mmDelete.defaultExpectation != nil {
...
// Then helper
func (mmDelete *mChatServiceMockDelete) When(ctx context.Context, i1 int64) *ChatServiceMockDeleteExpectation {
	if mmDelete.mock.funcDelete != nil {
		mmDelete.mock.t.Fatalf("ChatServiceMock.Delete mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockDeleteExpectation{
		mock:               mmDelete.mock,
		params:             &ChatServiceMockDeleteParams{ctx, i1},
...
// Delete implements mm_chat.ChatService
func (mmDelete *ChatServiceMock) Delete(ctx context.Context, i1 int64) (err error) {
	...
	mm_params := ChatServiceMockDeleteParams{ctx, i1}
	...
	if mmDelete.DeleteMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockDeleteParams{ctx, i1}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.i1 != nil && !minimock.Equal(*mm_want_ptrs.i1, mm_got.i1) {
				mmDelete.t.Errorf("ChatServiceMock.Delete got unexpected parameter i1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmDelete.t.Fatalf("Unexpected call to ChatServiceMock.Delete. %v %v", ctx, i1)
	return
}
...
func (mmSendMessage *mChatServiceMockSendMessage) Expect(ctx context.Context, mp1 *domain.Message) *mChatServiceMockSendMessage {
	...
	mmSendMessage.defaultExpectation.params = &ChatServiceMockSendMessageParams{ctx, mp1}
...
// ExpectMp1Param2 sets up expected param mp1 for ChatService.SendMessage
func (mmSendMessage *mChatServiceMockSendMessage) ExpectMp1Param2(mp1 *domain.Message) *mChatServiceMockSendMessage {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
...
func (mmSendMessage *mChatServiceMockSendMessage) Inspect(f func(ctx context.Context, mp1 *domain.Message)) *mChatServiceMockSendMessage {
...
func (mmSendMessage *mChatServiceMockSendMessage) Set(f func(ctx context.Context, mp1 *domain.Message) (err error)) *ChatServiceMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mChatServiceMockSendMessage) When(ctx context.Context, mp1 *domain.Message) *ChatServiceMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockSendMessageExpectation{
		...
		params:             &ChatServiceMockSendMessageParams{ctx, mp1},
...
// SendMessage implements mm_chat.ChatService
func (mmSendMessage *ChatServiceMock) SendMessage(ctx context.Context, mp1 *domain.Message) (err error) {
	...
	mm_params := ChatServiceMockSendMessageParams{ctx, mp1}
	...
	if mmSendMessage.SendMessageMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockSendMessageParams{ctx, mp1}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.mp1 != nil && !minimock.Equal(*mm_want_ptrs.mp1, mm_got.mp1) {
				mmSendMessage.t.Errorf("ChatServiceMock.SendMessage got unexpected parameter mp1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmSendMessage.t.Fatalf("Unexpected call to ChatServiceMock.SendMessage. %v %v", ctx, mp1)
	return
}
